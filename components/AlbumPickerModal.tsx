...
export default function AlbumPickerModal({ visible, albums, colors, onClose, onSelectAlbum }: Props) {
  return (
    <Modal visible={visible} transparent animationType="slide">
      <View style={styles.overlay}>
        <View style={[styles.content, { backgroundColor: colors.surface }]}>
          <View style={styles.header}>
            <Text style={[styles.title, { color: colors.text }]}>Añadir a álbum</Text>
            ...
            <ScrollView>
              {albums.map(a => (
                ...
                >
                  ...
                  <Text style={[styles.rowName, { color: colors.text }]}>{a.name}</Text>
                  <Text style={[styles.rowCount, { color: colors.textTertiary }]}>{a._count.photos} fotos</Text>
                </TouchableOpacity>
              ))}
            </ScrollView>
          )}
